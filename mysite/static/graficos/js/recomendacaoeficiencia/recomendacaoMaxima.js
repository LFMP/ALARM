function getRandomColor() {
      ...
      url = window.location.origin + "/admin/quantidadeRecMaxima";
    ...
    var layout = {
        title: 'Eficiência Máxima no Mês',
        xaxis: {title: {text: 'Recomendador'}},
        yaxis: {title: {text: 'Eficiência Percentual (%)'}},
    };

    Plotly.newPlot('recomendacaoMaxima', sets, layout, {displayModeBar: false},{showLink: true},{responsive: true});  
